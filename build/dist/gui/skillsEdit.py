...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.EditSkillDataTab = QWidget()
        self.EditSkillDataTab.setObjectName(u"EditSkillDataTab")
        self.abilityCategories = QTabWidget(self.EditSkillDataTab)
        self.abilityCategories.setObjectName(u"abilityCategories")
        self.abilityCategories.setGeometry(QRect(0, 10, 281, 571))
        self.STR = QWidget()
        self.STR.setObjectName(u"STR")
        self.abilityCategories.addTab(self.STR, "")
        self.STA = QWidget()
        self.STA.setObjectName(u"STA")
        self.abilityCategories.addTab(self.STA, "")
        self.INT = QWidget()
        self.INT.setObjectName(u"INT")
        self.abilityCategories.addTab(self.INT, "")
        self.SPRT = QWidget()
        self.SPRT.setObjectName(u"SPRT")
        self.abilityCategories.addTab(self.SPRT, "")
        self.LUCK = QWidget()
        self.LUCK.setObjectName(u"LUCK")
        self.abilityCategories.addTab(self.LUCK, "")
        self.infoFrame = QFrame(self.EditSkillDataTab)
        self.infoFrame.setObjectName(u"infoFrame")
        self.infoFrame.setGeometry(QRect(280, 30, 491, 551))
        ...
        self.label_13 = QLabel(self.EditSkillDataTab)
        self.label_13.setObjectName(u"label_13")
        self.label_13.setGeometry(QRect(40, 80, 701, 371))
        font6 = QFont()
        font6.setPointSize(200)
        self.label_13.setFont(font6)
        self.label_13.setLayoutDirection(Qt.LeftToRight)
        self.label_13.setAlignment(Qt.AlignCenter)
        self.MainTabs.addTab(self.EditSkillDataTab, "")
        ...
        self.abilityCategories.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.abilityCategories.setTabText(self.abilityCategories.indexOf(self.STR), QCoreApplication.translate("MainWindow", u"STR", None))
        self.abilityCategories.setTabText(self.abilityCategories.indexOf(self.STA), QCoreApplication.translate("MainWindow", u"STA", None))
        self.abilityCategories.setTabText(self.abilityCategories.indexOf(self.INT), QCoreApplication.translate("MainWindow", u"INT", None))
        self.abilityCategories.setTabText(self.abilityCategories.indexOf(self.SPRT), QCoreApplication.translate("MainWindow", u"SPRT", None))
        self.abilityCategories.setTabText(self.abilityCategories.indexOf(self.LUCK), QCoreApplication.translate("MainWindow", u"LUCK", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"WIP", None))
        self.MainTabs.setTabText(self.MainTabs.indexOf(self.EditSkillDataTab), QCoreApplication.translate("MainWindow", u"Edit Skill Data", None))
